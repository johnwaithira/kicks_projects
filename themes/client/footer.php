                            ...
                            <div class="inner-box">
                                ...
                                <div class="view_on_map">
                                    <div class="m-t-35">
                                        ...
                                        <img src="http://127.0.0.1/shoetailor/kicks_files/svgs/location.svg" style=" display:flex;justify-content: center;" class="w-20">    
                                        <span style=" display:grid;place-items: center;">View On Map</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
